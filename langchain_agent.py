...
# yfinace api를 사용하기 위한 tool 생성
from langchain_community.tools.yahoo_finance_news import YahooFinanceNewsTool

# arxiv 논문 검색을 위한 tools 생성 
...
# 일관된 값을 위하여 Temperature 0.1로 설정 model은 gpt-4o로도 설정 할수 있습니다.
openai = ChatOpenAI(
    model="gpt-4o-mini", api_key=os.getenv("OPENAI_API_KEY"), temperature=0.1)

#agent 시물레이션을 위한 prompt 가져오기
...
# agent llm 모델을 openai로 정의하고 tools, prompt를 입력하여 agent를 완성합니다.
